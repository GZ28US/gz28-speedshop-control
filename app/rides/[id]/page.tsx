...
const manufacturersByYear: Record<number, string[]> = {
  ...
  2014: ['GM'],
  2015: ['MOPAR', 'GM'], 2016: ['MOPAR', 'GM'], 2017: ['MOPAR', 'GM'], 2018: ['MOPAR', 'GM'],
  2019: ['MOPAR', 'GM'], 2020: ['MOPAR', 'GM'], 2021: ['MOPAR', 'GM'], 2022: ['MOPAR', 'GM'],
  2023: ['MOPAR', 'GM'],
  2024: ['GM'], 2025: ['GM'], 2026: ['GM'],
}

const brandsByManufacturerAndYear: Record<string, Record<number, string[]>> = {
  MOPAR: {
    2009: ['RAM'], 2010: ['RAM'], 2011: ['RAM'], 2012: ['RAM'], 2013: ['RAM'],
    2014: ['RAM'], 2015: ['RAM'], 2016: ['RAM'], 2017: ['RAM'],
    2018: ['DODGE', 'RAM'],
  ...
  GM: {
    ...
    2022: ['CHEVROLET'], 2023: ['CHEVROLET'], 2024: ['CHEVROLET'], 2025: ['CHEVROLET'],
    2026: ['CHEVROLET'],
  },
}
...
const modelsByBrandAndYear: Record<string, Record<number, string[]>> = {
  DODGE: {
    2018: ['CHALLENGER', 'CHARGER'], 2019: ['CHALLENGER', 'CHARGER'],
    2020: ['CHALLENGER', 'CHARGER'], 2021: ['CHALLENGER', 'CHARGER'],
    2022: ['CHALLENGER', 'CHARGER'], 2023: ['CHALLENGER', 'CHARGER'],
  },
  RAM: {
  ...
  CHEVROLET: {
    2014: ['CORVETTE'], 2015: ['CORVETTE'],
    2016: ['CAMARO', 'CORVETTE'], 2017: ['CAMARO', 'CORVETTE'],
    2018: ['CAMARO', 'CORVETTE'], 2019: ['CAMARO', 'CORVETTE'],
    2020: ['CAMARO', 'CORVETTE'], 2021: ['CAMARO', 'CORVETTE'],
    2022: ['CAMARO', 'CORVETTE'], 2023: ['CAMARO', 'CORVETTE'],
    2024: ['CAMARO', 'CORVETTE'],
    2025: ['CORVETTE'], 2026: ['CORVETTE'],
  },
}
...
export default function EditRidePage() {
  ...
  }, [year, manufacturer, brand, loading])
  ...
  useEffect(() => {
    ...
    if (!options.includes(specialEdition)) {
      setSpecialEdition(options[0] || 'None')
    }
  }, [year, model, version, specialEdition, loading])
  ...
  }, [year, brand, model, version, specialEdition, color, loading])
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-black text-white p-8">
        <Header />
        <p className="text-xl text-gray-400">Loading ride...</p>
      </main>
    )
  }
  ...
  return (
    <main className="min-h-screen bg-black text-white p-8">
      ...
      <h2 className="text-4xl font-bold mb-8">EDIT RIDE</h2>
      ...
      <div className="grid grid-cols-1 gap-5 max-w-2xl">
        ...
        <button onClick={updateRide} className="bg-green-700 hover:bg-green-600 px-6 py-4 rounded-2xl text-xl font-bold">
          SAVE CHANGES
        </button>

        <button onClick={deleteRide} className="bg-red-700 hover:bg-red-600 px-6 py-4 rounded-2xl text-xl font-bold">
          DELETE RIDE
        </button>
